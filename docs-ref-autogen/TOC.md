...
## [Installieren](../docs-ref-conceptual/install-azure-cli.md)
## [Erste Schritte](../docs-ref-conceptual/get-started-with-azure-cli.md)
## [Anmelden](../docs-ref-conceptual/authenticate-azure-cli.md)
### [Erstellen eines Dienstprinzipals](../docs-ref-conceptual/create-an-azure-service-principal-azure-cli.md)
## [Ausgabeformate](../docs-ref-conceptual/format-output-azure-cli.md)
## [Abfragen](../docs-ref-conceptual/query-azure-cli.md)
## [Abonnements](../docs-ref-conceptual/manage-azure-subscriptions-azure-cli.md)
## [Versionshinweise](../docs-ref-conceptual/release-notes-azure-cli.md)
# Sample Scripts
...
#### [List](cdn\profile.pycliyml#list "az cdn profile list")
...
## [Cognitiveservices](cognitiveservices.pycliyml "az cognitiveservices")
...
### [Collection](documentdb\collection.pycliyml "az documentdb collection")
#### [Create](documentdb\collection.pycliyml#create "az documentdb collection create")
#### [Delete](documentdb\collection.pycliyml#delete "az documentdb collection delete")
#### [Exists](documentdb\collection.pycliyml#exists "az documentdb collection exists")
#### [List](documentdb\collection.pycliyml#list "az documentdb collection list")
#### [Show](documentdb\collection.pycliyml#show "az documentdb collection show")
#### [Update](documentdb\collection.pycliyml#update "az documentdb collection update")
### [Database](documentdb\database.pycliyml "az documentdb database")
#### [Create](documentdb\database.pycliyml#create "az documentdb database create")
#### [Delete](documentdb\database.pycliyml#delete "az documentdb database delete")
#### [Exists](documentdb\database.pycliyml#exists "az documentdb database exists")
#### [List](documentdb\database.pycliyml#list "az documentdb database list")
#### [Show](documentdb\database.pycliyml#show "az documentdb database show")
## [Functionapp](functionapp.pycliyml "az functionapp")
...
##### [Delete](functionapp\config\hostname.pycliyml#delete "az functionapp config hostname delete")
...
## [Managedapp](managedapp.pycliyml "az managedapp")
...
#### [Health](sf\partition.pycliyml#health "az sf partition health")
...
#### [Health](sf\replica.pycliyml#health "az sf replica health")
...
#### [Create](sf\service.pycliyml#create "az sf service create")
#### [Description](sf\service.pycliyml#description "az sf service description")
#### [Health](sf\service.pycliyml#health "az sf service health")
#### [List](sf\service.pycliyml#list "az sf service list")
...
#### [Resolve](sf\service.pycliyml#resolve "az sf service resolve")
#### [Update](sf\service.pycliyml#update "az sf service update")
...
## [Webapp](webapp.pycliyml "az webapp")
### [Browse](webapp.pycliyml#browse "az webapp browse")
### [Create](webapp.pycliyml#create "az webapp create")
### [Delete](webapp.pycliyml#delete "az webapp delete")
### [List](webapp.pycliyml#list "az webapp list")
### [List-Runtimes](webapp.pycliyml#list-runtimes "az webapp list-runtimes")
### [Restart](webapp.pycliyml#restart "az webapp restart")
### [Show](webapp.pycliyml#show "az webapp show")
### [Start](webapp.pycliyml#start "az webapp start")
### [Stop](webapp.pycliyml#stop "az webapp stop")
### [Config](webapp\config.pycliyml "az webapp config")
#### [Set](webapp\config.pycliyml#set "az webapp config set")
#### [Show](webapp\config.pycliyml#show "az webapp config show")
#### [Appsettings](webapp\config\appsettings.pycliyml "az webapp config appsettings")
##### [Delete](webapp\config\appsettings.pycliyml#delete "az webapp config appsettings delete")
##### [List](webapp\config\appsettings.pycliyml#list "az webapp config appsettings list")
##### [Set](webapp\config\appsettings.pycliyml#set "az webapp config appsettings set")
#### [Backup](webapp\config\backup.pycliyml "az webapp config backup")
##### [Create](webapp\config\backup.pycliyml#create "az webapp config backup create")
##### [List](webapp\config\backup.pycliyml#list "az webapp config backup list")
##### [Restore](webapp\config\backup.pycliyml#restore "az webapp config backup restore")
##### [Show](webapp\config\backup.pycliyml#show "az webapp config backup show")
##### [Update](webapp\config\backup.pycliyml#update "az webapp config backup update")
#### [Connection-String](webapp\config\connection-string.pycliyml "az webapp config connection-string")
##### [Delete](webapp\config\connection-string.pycliyml#delete "az webapp config connection-string delete")
##### [List](webapp\config\connection-string.pycliyml#list "az webapp config connection-string list")
##### [Set](webapp\config\connection-string.pycliyml#set "az webapp config connection-string set")
#### [Container](webapp\config\container.pycliyml "az webapp config container")
##### [Delete](webapp\config\container.pycliyml#delete "az webapp config container delete")
##### [Set](webapp\config\container.pycliyml#set "az webapp config container set")
##### [Show](webapp\config\container.pycliyml#show "az webapp config container show")
#### [Hostname](webapp\config\hostname.pycliyml "az webapp config hostname")
##### [Add](webapp\config\hostname.pycliyml#add "az webapp config hostname add")
##### [Delete](webapp\config\hostname.pycliyml#delete "az webapp config hostname delete")
##### [Get-External-Ip](webapp\config\hostname.pycliyml#get-external-ip "az webapp config hostname get-external-ip")
##### [List](webapp\config\hostname.pycliyml#list "az webapp config hostname list")
#### [Ssl](webapp\config\ssl.pycliyml "az webapp config ssl")
##### [Bind](webapp\config\ssl.pycliyml#bind "az webapp config ssl bind")
##### [Delete](webapp\config\ssl.pycliyml#delete "az webapp config ssl delete")
##### [List](webapp\config\ssl.pycliyml#list "az webapp config ssl list")
##### [Unbind](webapp\config\ssl.pycliyml#unbind "az webapp config ssl unbind")
##### [Upload](webapp\config\ssl.pycliyml#upload "az webapp config ssl upload")
### [Deployment](webapp\deployment.pycliyml "az webapp deployment")
...
##### [Create](webapp\deployment\slot.pycliyml#create "az webapp deployment slot create")
##### [Delete](webapp\deployment\slot.pycliyml#delete "az webapp deployment slot delete")
##### [List](webapp\deployment\slot.pycliyml#list "az webapp deployment slot list")
##### [Swap](webapp\deployment\slot.pycliyml#swap "az webapp deployment slot swap")
...
##### [Delete](webapp\deployment\source.pycliyml#delete "az webapp deployment source delete")
##### [Show](webapp\deployment\source.pycliyml#show "az webapp deployment source show")
##### [Sync](webapp\deployment\source.pycliyml#sync "az webapp deployment source sync")
##### [Update-Token](webapp\deployment\source.pycliyml#update-token "az webapp deployment source update-token")
#### [User](webapp\deployment\user.pycliyml "az webapp deployment user")
##### [Set](webapp\deployment\user.pycliyml#set "az webapp deployment user set")
##### [Show](webapp\deployment\user.pycliyml#show "az webapp deployment user show")
